...
import cn.yang.galleryfinal.PhotoEditActivity;
...
public class PhotoEditListAdapter extends ViewHolderAdapter<PhotoEditListAdapter.ViewHolder, PhotoInfo> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        GalleryFinal.getCoreConfig().getImageLoader().displayImage(mActivity, path, holder.mIvPhoto, R.drawable.ic_gf_default_photo, 100, 100);
